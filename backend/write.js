...
const tokenContract = "0x4fD77Bc61A06fB4194Fa40245E090035FDAbb556";
...
console.log("✅ Paste this into Etherscan 'aggregate' function input:");
console.log(JSON.stringify(calls, null, 2));

const encodedCall = aggregateInterface.encodeFunctionData("aggregate", [calls]);
console.log("\n✅ Encoded Calldata for raw tx:");
